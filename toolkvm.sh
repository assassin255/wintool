...
4) WIN_NAME="Windows 10 LTSB"; WIN_URL="https://archive.org/download/win_20260208/win.img"; USE_UEFI="no" ;;
...
cpu_model="host,hypervisor=off,tsc=on,invtsc=on,pmu=off,l3-cache=on,+cmov,+mmx,+fxsr,+sse2,+ssse3,+sse4.1,+sse4.2,+popcnt,+aes,+cx16,+x2apic,+sep,+pat,+pse"
